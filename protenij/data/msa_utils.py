...
from protenij.data.constants import (
    PRO_STD_RESIDUES,
...
from protenij.openfold_local.data import parsers
from protenij.openfold_local.data.msa_identifiers import (
    Identifiers,
    _extract_sequence_identifier,
    _parse_sequence_identifier,
)
from protenij.openfold_local.data.msa_pairing import (
    CHAIN_FEATURES,
    MSA_FEATURES,
    MSA_GAP_IDX,
    MSA_PAD_VALUES,
...
from protenij.openfold_local.np import residue_constants
...
try:
    from protenij.openfold_local.data.tools import jackhmmer
except ImportError:
    print(
