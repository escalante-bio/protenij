...
from protenij.data.json_maker import cif_to_input_json
from protenij.data.json_parser import lig_file_to_atom_info
from protenij.data.utils import pdb_to_cif
from protenij.utils.logger import get_logger
from protenij.runner.inference import InferenceRunner, download_infercence_cache, infer_predict
from protenij.runner.msa_search import msa_search, update_infer_json
...
def predict(
    ...
    """
    predict: Run predictions with protenij.
